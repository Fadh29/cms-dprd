        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    @can('delete permissions')
                                        <a href="javascript:void(0);"
                                            onclick="openDeleteModal({{ $permission->id }}, '{{ $permission->name }}')"
            ...
            <div id="deleteModal"
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 w-96">
                    ...
                    <p class="text-gray-600 mt-2">Apakah Anda yakin ingin menghapus <b>{{ $permission->id }}</b>?</p>
    ...
    <x-slot name="script">
        <script type="text/javascript">
            ...
            document.getElementById("confirmDelete").addEventListener("click", function() {
                if (deleteId) {
                    fetch('{{ route('permissions.destroy', ':id') }}'.replace(':id', deleteId), {
                            method: "DELETE",
                            headers: {
                        ...
                        .then(data => {
                            if (data.status) {
                                closeDeleteModal();
                                window.location.href = '{{ route('permissions.index') }}'; // Redirect langsung
                            }
                        })
                        .catch(error => {
